...
Source0  : https://download.kde.org/stable/frameworks/5.105/bluez-qt-5.105.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.105/bluez-qt-5.105.0.tar.xz.sig
...
%prep
%setup -q -n bluez-qt-5.105.0
cd %{_builddir}/bluez-qt-5.105.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1681140170
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BluezQt.so.5.105.0
