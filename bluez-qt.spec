...
Version  : 6.2.0
Release  : 84
URL      : https://download.kde.org/stable/frameworks/6.2/bluez-qt-6.2.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.2/bluez-qt-6.2.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.2/bluez-qt-6.2.0.tar.xz.sig
...
%setup -q -n bluez-qt-6.2.0
cd %{_builddir}/bluez-qt-6.2.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715623037
mkdir -p clr-build
pushd clr-build
