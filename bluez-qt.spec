...
Version  : 6.11.0
Release  : 95
URL      : https://download.kde.org/stable/frameworks/6.11/bluez-qt-6.11.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.11/bluez-qt-6.11.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.11/bluez-qt-6.11.0.tar.xz.sig
...
%setup -q -n bluez-qt-6.11.0
cd %{_builddir}/bluez-qt-6.11.0
pushd ..
cp -a bluez-qt-6.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739566787
mkdir -p clr-build
pushd clr-build
