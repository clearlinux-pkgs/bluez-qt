...
Version  : 6.3.0
Release  : 85
URL      : https://download.kde.org/stable/frameworks/6.3/bluez-qt-6.3.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.3/bluez-qt-6.3.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.3/bluez-qt-6.3.0.tar.xz.sig
...
%setup -q -n bluez-qt-6.3.0
cd %{_builddir}/bluez-qt-6.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717782238
mkdir -p clr-build
pushd clr-build
