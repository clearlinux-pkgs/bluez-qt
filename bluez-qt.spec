...
Version  : 6.7.0
Release  : 91
URL      : https://download.kde.org/stable/frameworks/6.7/bluez-qt-6.7.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.7/bluez-qt-6.7.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.7/bluez-qt-6.7.0.tar.xz.sig
...
%setup -q -n bluez-qt-6.7.0
cd %{_builddir}/bluez-qt-6.7.0
pushd ..
cp -a bluez-qt-6.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728691730
mkdir -p clr-build
pushd clr-build
