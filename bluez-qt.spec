...
Version  : 5.67.0
Release  : 26
URL      : https://download.kde.org/stable/frameworks/5.67/bluez-qt-5.67.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.67/bluez-qt-5.67.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.67/bluez-qt-5.67.0.tar.xz.sig
...
%prep
%setup -q -n bluez-qt-5.67.0
cd %{_builddir}/bluez-qt-5.67.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581275394
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bluez-qt-5.67.0/COPYING.LIB %{buildroot}/usr/share/package-licenses/bluez-qt/01a6b4bf79aca9b556822601186afab86e8c4fbf
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BluezQt.so.5.67.0
