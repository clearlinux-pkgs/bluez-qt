...
Version  : 5.102.0
Release  : 59
URL      : https://download.kde.org/stable/frameworks/5.102/bluez-qt-5.102.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.102/bluez-qt-5.102.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.102/bluez-qt-5.102.0.tar.xz.sig
...
%prep
%setup -q -n bluez-qt-5.102.0
cd %{_builddir}/bluez-qt-5.102.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1673899500
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BluezQt.so.5.102.0
