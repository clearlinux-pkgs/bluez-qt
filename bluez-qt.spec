...
Version  : 6.12.0
Release  : 96
URL      : https://download.kde.org/stable/frameworks/6.12/bluez-qt-6.12.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/6.12/bluez-qt-6.12.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.12/bluez-qt-6.12.0.tar.xz.sig
...
%setup -q -n bluez-qt-6.12.0
cd %{_builddir}/bluez-qt-6.12.0
pushd ..
cp -a bluez-qt-6.12.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742477985
mkdir -p clr-build
pushd clr-build
