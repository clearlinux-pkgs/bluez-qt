...
Version  : 5.53.0
Release  : 10
URL      : https://download.kde.org/stable/frameworks/5.53/bluez-qt-5.53.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.53/bluez-qt-5.53.0.tar.xz
Source99 : https://download.kde.org/stable/frameworks/5.53/bluez-qt-5.53.0.tar.xz.sig
...
export LANG=C
export SOURCE_DATE_EPOCH=1544475197
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BluezQt.so.5.53.0
