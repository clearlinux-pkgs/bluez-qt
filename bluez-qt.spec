...
Source0  : https://download.kde.org/stable/frameworks/6.0/bluez-qt-6.0.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/6.0/bluez-qt-6.0.0.tar.xz.sig
...
%prep
%setup -q -n bluez-qt-6.0.0
cd %{_builddir}/bluez-qt-6.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709274344
mkdir -p clr-build
pushd clr-build
