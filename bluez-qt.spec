...
Version  : 5.108.0
Release  : 67
URL      : https://download.kde.org/stable/frameworks/5.108/bluez-qt-5.108.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.108/bluez-qt-5.108.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.108/bluez-qt-5.108.0.tar.xz.sig
...
%prep
%setup -q -n bluez-qt-5.108.0
cd %{_builddir}/bluez-qt-5.108.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1688863627
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libKF5BluezQt.so.5.108.0
/V3/usr/lib64/qt5/qml/org/kde/bluezqt/libbluezqtextensionplugin.so
/usr/lib64/libKF5BluezQt.so.5.108.0
