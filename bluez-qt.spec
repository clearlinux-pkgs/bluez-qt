...
Version  : 5.95.0
Release  : 52
URL      : https://download.kde.org/stable/frameworks/5.95/bluez-qt-5.95.0.tar.xz
Source0  : https://download.kde.org/stable/frameworks/5.95/bluez-qt-5.95.0.tar.xz
Source1  : https://download.kde.org/stable/frameworks/5.95/bluez-qt-5.95.0.tar.xz.sig
...
%prep
%setup -q -n bluez-qt-5.95.0
cd %{_builddir}/bluez-qt-5.95.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1655143615
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bluez-qt-5.95.0/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/bluez-qt/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/bluez-qt-5.95.0/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/bluez-qt/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/bluez-qt-5.95.0/LICENSES/LGPL-2.1-or-later.txt %{buildroot}/usr/share/package-licenses/bluez-qt/6f1f675aa5f6a2bbaa573b8343044b166be28399
cp %{_builddir}/bluez-qt-5.95.0/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/bluez-qt/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/bluez-qt-5.95.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/bluez-qt/e458941548e0864907e654fa2e192844ae90fc32
cp %{_builddir}/bluez-qt-5.95.0/LICENSES/LicenseRef-KDE-Accepted-LGPL.txt %{buildroot}/usr/share/package-licenses/bluez-qt/e458941548e0864907e654fa2e192844ae90fc32
pushd clr-build
%make_install
popd
...
%files lib
%defattr(-,root,root,-)
/usr/lib64/libKF5BluezQt.so.5.95.0
